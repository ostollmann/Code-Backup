...
class Kohana_Request_Client_External extends Request_Client {
	...
	protected function _curl_execute(Request $request)
	{
		...
		// TODO: is this right (POSTing with curl)?
		// Process posts (o1iver)
		if ($posts = $request->post())
		{
			$options[CURLOPT_POSTFIELDS] = http_build_query($posts, NULL, '&');
		}
		
		// Add custom METHOD to support non GET/POST methods
