...
getLibDir = getPrefixDirRel "snaptest-0.1\\ghc-7.0.2"

getDataDir :: IO FilePath
getDataDir =  catch (getEnv "snaptest_datadir") (\_ -> getPrefixDirRel "snaptest-0.1")

getLibexecDir :: IO FilePath
getLibexecDir = getPrefixDirRel "snaptest-0.1"
