...
getLibDir = getPrefixDirRel "helloSnap-0.1\\ghc-7.0.2"

getDataDir :: IO FilePath
getDataDir =  catch (getEnv "helloSnap_datadir") (\_ -> getPrefixDirRel "helloSnap-0.1")

getLibexecDir :: IO FilePath
getLibexecDir = getPrefixDirRel "helloSnap-0.1"
