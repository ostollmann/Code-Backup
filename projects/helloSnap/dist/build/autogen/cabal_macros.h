...
/* package snap-0.4.3 */
#define VERSION_snap "0.4.3"
#define MIN_VERSION_snap(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
  (major1) == 0 && (major2) == 4 && (minor) <= 3)

/* package snap-core-0.4.3 */
#define VERSION_snap_core "0.4.3"
#define MIN_VERSION_snap_core(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
  (major1) == 0 && (major2) == 4 && (minor) <= 3)

/* package snap-server-0.4.3 */
#define VERSION_snap_server "0.4.3"
