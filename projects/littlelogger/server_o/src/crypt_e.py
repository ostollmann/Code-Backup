...
print 'Reading plaintext from file...'
...
strcipher = p3_encrypt(strplain, key)

print 'Writing cipher to file:\n========================================================\n\'%s\'\n========================================================\n' % strcipher
cif = open('cipher.txt', 'wb')
cif.write(strcipher)
cif.close()

print 'Reading cipher from file...'
...
dplain = p3_decrypt(fcipher, key)
print 'Writing decrypted plain to file:\n========================================================\n\'%s\'\n========================================================\n' % dplain
